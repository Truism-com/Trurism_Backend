...
class CouponServiceType(str, enum.Enum):
    """Service types supported by coupons."""
    FLIGHT = "flight"
    HOTEL = "hotel"
    BUS = "bus"
    ALL = "all"
...
class Coupon(Base):
    """Customer-facing promo/coupon codes."""
    ...
    service_type: Mapped[CouponServiceType] = mapped_column(
        SQLEnum(CouponServiceType), nullable=False, default=CouponServiceType.ALL
    )
