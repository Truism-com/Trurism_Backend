    ...
    def post_init_processing(self):
        ...
        if "postgresql+asyncpg://" in self.database_url:
            ...
            if "ssl=" not in self.database_url:
                ...
                is_remote_host = any(host in self.database_url for host in ["render.com", ".onrender.com", ".amazonaws.com", "cloud", "managed", ".supabase.co", "pooler.supabase.com", ".azure.com", ".postgres.database.azure.com"])
